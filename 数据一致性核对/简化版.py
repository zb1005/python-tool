...
if __name__ == "__main__":
    SOURCE_FILE = r"C:\Users\zhangbon\Desktop\核对数据集\3、EBOM-0528 - 范围一致的核对表.xlsx"
    TARGET_FILE = r"C:\Users\zhangbon\Desktop\核对数据集\3、MBOM-0528 - 范围一致的核对表.xlsx"
    KEY_COLUMNS = ["父级物料编码","项目号"]  # 主键列
    # KEY_COLUMNS = ["工厂", "物料编码","组件"]
    OUTPUT_FILE = r"C:\Users\zhangbon\Desktop\核对数据集\EBOM是源--核对结果.xlsx"
